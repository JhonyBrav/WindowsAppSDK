...
$packageMapping = @(
    [pscustomobject]@{
        ...
        Identifier='WAR_FRAMEWORK_X86_PATH'
    }
    [pscustomobject]@{
        Package='framework_x64.msix';
        Identifier='WAR_FRAMEWORK_X64_PATH'
    }
    [pscustomobject]@{
        Package='framework_arm64.msix';
        Identifier='WAR_FRAMEWORK_ARM64_PATH'
    }
    [pscustomobject]@{
        Package='main_x86.msix';
        Identifier='WAR_MAIN_X86_PATH'
    }
    [pscustomobject]@{
        Package='main_x64.msix';
        Identifier='WAR_MAIN_X64_PATH'
    }
    [pscustomobject]@{
        Package='main_arm64.msix';
        Identifier='WAR_MAIN_ARM64_PATH'
    }
    [pscustomobject]@{
        Package='singleton_x86.msix';
        Identifier='WAR_SINGLETON_X86_PATH'
    }
    [pscustomobject]@{
        Package='singleton_x64.msix';
        Identifier='WAR_SINGLETON_X64_PATH'
    }
    [pscustomobject]@{
        Package='singleton_arm64.msix';
        Identifier='WAR_SINGLETON_ARM64_PATH'
    }
    [pscustomobject]@{
        Package='ddlm_x86.msix';
        Identifier='WAR_DDLM_X86_PATH'
    }
    [pscustomobject]@{
        Package='ddlm_x64.msix';
        Identifier='WAR_DDLM_X64_PATH'
    }
    [pscustomobject]@{
        Package='ddlm_arm64.msix';
        Identifier='WAR_DDLM_ARM64_PATH'
    }
)
